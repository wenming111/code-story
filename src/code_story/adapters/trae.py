"""Trae adapter (v2 stub).

Trae (and Trae CN) is a VS Code fork; its chat history lives in a SQLite
key-value store at
~/Library/Application Support/Trae[ CN]/User/globalStorage/state.vscdb (macOS).
...
work for Trae today -- only automatic conversation-body extraction is pending.
"""
